...
class ReplyCommentScreen extends StatefulWidget {
  ...
  const ReplyCommentScreen({Key? key,required this.postId, required this.commentId})
      : super(key: key);
                          ...
                          trailing: GestureDetector(
                              onTap: () async {
                                ...
                                await Provider.of<PostVM>(context,
                                        listen: false)
                                    .createReplyComment(widget.postId,
                                         widget.commentId, _commentTextEditController.text);
